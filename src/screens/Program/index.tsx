...
import { Podcast, Header, GradientContainer } from "../../components";
  ...
  return (
    <>
      ...
      <Container onScroll={scrollHandler} scrollEventThrottle={16}>
        <GradientContainer color={"#9B9F46"} opacity={0.75}>
          <ProgramContainer>
            <Head>
              <Avatar
                source={{
            ...
            <Description>
              ...
              o mundo inteiro ao seu próprio umbigo, interpretando tudo de forma
              egoísta, ignorante e burra. Se você acha que existe certo e
              errado, tem convicções e opiniões sobre tudo, não dê play. O QI
              máximo para poder aproveitar esse podcast é 30.
            </Description>
          </ProgramContainer>
